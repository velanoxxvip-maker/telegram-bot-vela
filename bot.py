...
1️⃣ Tu comprobante de pago 📸
2️⃣ Tu @usuario de Telegram (ejemplo: @juan23, @carlitos89).
...
⚠️ IMPORTANTE: Para recibir tu acceso debes mandarme tu @usuario de Telegram (ejemplo: @juan23). Sin esto NO puedo enviarte el link VIP.
