...
# --- CONFIGURACIÓN ---
TOKEN = os.getenv("8132000016:AAGqyySMmWLCGLWodDJHCM_NDg92Lmc0D7s")
ADMIN_ID = int(os.getenv("5115300163"))
...
MENSAJE_PROMOS = """💎 por el momento no hay promocion, te aviso pronto o entra al grupo vip
"""
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "vip":
        ...
        await context.bot.send_photo(chat_id=query.message.chat_id, photo=open("assets/qr_vip.jpeg", "rb"))

    elif query.data == "promos":
        await query.message.reply_text(MENSAJE_PROMOS, parse_mode="Markdown")
        await context.bot.send_photo(chat_id=query.message.chat_id, photo=open("assets/qr_promo.jpeg", "rb"))
