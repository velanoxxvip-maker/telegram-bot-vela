...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "vip":
        ...
        await context.bot.send_photo(chat_id=query.message.chat_id, photo=open("assets/qr_vip.png", "rb"))

    elif query.data == "promos":
        await query.message.reply_text(MENSAJE_PROMOS, parse_mode="Markdown")
        await context.bot.send_photo(chat_id=query.message.chat_id, photo=open("assets/qr_promo.png", "rb"))
